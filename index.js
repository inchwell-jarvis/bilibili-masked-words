...
(function() {
    ...
    liElement.className = 'v-popover-wrap';
    liElement.innerHTML = '<a target="_blank" class="default-entry"><span>设置屏蔽词</span></a>';
    liElement.style.marginLeft = '20px';

    //找到插入按钮的位置
    var leftEntry = document.querySelector('.left-entry');
    ...
    liElement.addEventListener('click', function() {
        ...
        input.style.cssText = 'width: 500px; height: 37px; padding: 10px; border: 1px solid #ccc; border-radius: 5px; outline: none; transition: border-color 0.3s ease-in-out;';
